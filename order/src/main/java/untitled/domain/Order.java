...
public class Order {
    ...
    public static void sendAlret(StockIncreased stockIncreased) {
    ...
    //>>> Clean Arch / Port Method
    //<<< Clean Arch / Port Method
    public static void updateStatus(DeliveryComplated deliveryComplated) {
        //implement business logic here:
        ...
        */
        ...
        repository().findById(deliveryComplated.get???()).ifPresent(order->{
